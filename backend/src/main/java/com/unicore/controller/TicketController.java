...
public class TicketController {
    ...
    public ResponseEntity<TicketResponseDTO> cancelTicket(@PathVariable Long id, Authentication authentication) {
        return ResponseEntity.ok(ticketService.cancelTicket(id, securityUtils.getCurrentUserId(authentication)));
    }
    ...
    public ResponseEntity<TicketResponseDTO> updateTicket(
            ...
            @Valid @RequestBody TicketRequestDTO request,
            Authentication authentication) {
        return ResponseEntity.ok(ticketService.updateTicket(id, request, securityUtils.getCurrentUserId(authentication)));
    }
