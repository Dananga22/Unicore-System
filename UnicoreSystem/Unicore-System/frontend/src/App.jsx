...
const menuItems = [
  ...
  { to: '/admin/cancellations', label: 'Cancellation Requests', icon: XCircle, roles: ['ADMIN'] },
  { to: '/admin/calendar', label: 'Operations Calendar', icon: CalendarDays, roles: ['ADMIN'] },
  ...
  return (
    <div className="dashboard-shell">
      ...
      <div className="dashboard-main">
        ...
        {userData.role === 'USER' && <SupportChatbot userData={userData} />}
      </div>
    </div>
  );
}
  ...
  return (
    ...
    >
      <Routes>
        ...
        <Route path="/bookings/edit/:id" element={<ProtectedRoute userData={userData} roles={['USER']}><BookingForm userData={userData} /></ProtectedRoute>} />
        ...
        <Route path="/tickets/:id/edit" element={<ProtectedRoute userData={userData}><TicketForm userData={userData} /></ProtectedRoute>} />
        ...
        <Route path="/admin/cancellations" element={<ProtectedRoute userData={userData} roles={['ADMIN']}><AdminCancellationRequests userData={userData} /></ProtectedRoute>} />
        <Route path="/admin/calendar" element={<ProtectedRoute userData={userData} roles={['ADMIN']}><AdminOperationsCalendar userData={userData} /></ProtectedRoute>} />
